...
const PayslipModal: React.FC<{
    ...
    const handlePrint = () => {
        const printContentNode = document.getElementById('user-payslip-to-print');
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4">
            <div className="bg-surface p-6 rounded-lg w-full max-w-4xl border border-border-color max-h-[90vh] overflow-y-auto">
                ...
                <div id="user-payslip-to-print" className="bg-white text-black p-4 font-mono text-xs mx-auto border border-gray-300">
