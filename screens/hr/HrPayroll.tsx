...
`;
    ...
    return (
        <div className="bg-white text-black p-8 font-mono text-xs max-w-4xl mx-auto border border-gray-300" style={{ fontFamily: "'Courier New', Courier, monospace", fontSize: '12px' }}>
...
const HrPayroll: React.FC = () => {
    ...
    const handlePrint = () => {
        ...
        document.body.innerHTML = `<pre style="font-family: 'Courier New', Courier, monospace; font-size: 12px; white-space: pre;">${printContent.replace(/<br\s*\/?>/gi, '\n')}</pre>`;
        window.print();
