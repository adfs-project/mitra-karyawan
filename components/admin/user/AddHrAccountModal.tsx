...
const AddHrAccountModal: React.FC<AddHrAccountModalProps> = ({ isOpen, onClose }) => {
    ...
    const existingBranches = [...new Set(users.map(u => u.profile.branch).filter(Boolean))];
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="branch" value={formData.branch} onChange={handleChange} required className="w-full p-2 bg-surface-light rounded border border-border-color">
