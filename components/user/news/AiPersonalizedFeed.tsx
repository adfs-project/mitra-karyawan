    ...
    return (
        <div className="text-center p-8 bg-surface rounded-lg border border-border-color">
            ...
            <p className="mt-2 text-text-secondary text-sm max-w-sm mx-auto">
                Untuk melindungi privasi Anda, AI kami tidak mengakses data pribadi Anda untuk membuat feed yang dipersonalisasi. Silakan jelajahi tab 'Global' untuk melihat semua berita dan info terbaru.
            </p>
        </div>
    );
};
